...
ActiveRecord::Schema.define(version: 20160429233029) do
  ...
  add_index "registered_applications", ["user_id", "created_at"], name: "index_registered_applications_on_user_id_and_created_at", using: :btree
